<template>
    <el-card>
        <h4>KELOLA GALERI PROGRAM</h4>
        <hr>

        <el-form :inline="true" style="text-align:right;">
            <el-form-item>
                <el-button @click="addData" type="primary"><i class="el-icon-plus"></i> Tambah Foto</el-button>
            </el-form-item>
            <el-form-item>
        ...
        @sort-change="sortChange">
            ...
            <el-table-column prop="program.name_id" label="Program"></el-table-column>
                    ...
                    <el-form label-width="120px" label-position="right" :model="formModel">
                        <el-tabs tab-position="top" type="card">
                            ...
                            <el-tab-pane label="Arabic">
                                <br>
                                <el-form-item label="Title">
                                    <el-input placeholder="Title" v-model="formModel.title_ar"></el-input>
...
export default {
    ...
    methods: {
        ...
        store: function() {
            this.loading = true;
            axios.post(BASE_URL + '/programGallery', this.formModel)
                .then(r => {
                    this.loading = false;
                    this.showForm = false;
                    this.$message({
        ...
        update: function() {
            this.loading = true;
            axios.put(BASE_URL + '/programGallery/' + this.formModel.id, this.formModel)
                .then(r => {
                    this.loading = false;
                    this.showForm = false
                    this.$message({
        ...
        addData: function() {
            this.formTitle = 'Tambah Galeri Program'
            this.error = {}
            this.formErrors = {}
            this.formModel = {}
            this.showForm = true
        ...
        editData: function(data) {
            this.formTitle = 'Edit Galeri Program'
        ...
        deleteData: function(id) {
            this.$confirm('Anda yakin akan menghapus data ini?')
                .then(() => {
                    axios.delete(BASE_URL + '/programGallery/' + id)
                        .then(r => {
                            this.requestData();
                            this.$message({
        ...
        requestData: function() {
            ...
            axios.get(BASE_URL + '/programGallery', {params: Object.assign(params, this.filters)})
                .then(r => {
                    this.loading = false;
